 ...
 */
// package org.apache.mesos.docker;
 ...
 */
public class TestDockerFramework {

  /** Show command-line usage. */
  private static void usage() {
    String name = TestDockerFramework.class.getName();
   ...
   * <br/>
   * Example usage: java TestDockerFramework 127.0.0.1:5050 fedora/apache 2
   */
  public static void main(String[] args) throws Exception {
    ...
    final Scheduler scheduler = new TestDockerScheduler(
        imageName,
        totalTasks
    );
